...
### Расписание
| Время (UTC) | Время (Алматы) | Тип |
|-------------|----------------|-----|
| 08:00 | 14:00 | Утренний дайджест |
| 13:00 | 19:00 | Дневной дайджест |
| 18:00 | 00:00 | Вечерний дайджест |

### Workflow

```
┌─────────────────────────────────────────────────────────────────┐
│                    CRON TRIGGER (08:00/13:00/18:00)             │
└─────────────────────────────────┬───────────────────────────────┘
                                  │
                                  ▼
┌─────────────────────────────────────────────────────────────────┐
...
| 🗑️ Мусор | -5 | Источник может быть исключён |
...
| Файл | Назначение |
|------|------------|
| `digest-format-final.md` | Формат сообщений |
...
|-----|------------|----------|
| Утренний дайджест | 08:00 UTC | Новости |
| Дневной дайджест | 13:00 UTC | Новости |
| Вечерний дайджест | 18:00 UTC | Новости |
